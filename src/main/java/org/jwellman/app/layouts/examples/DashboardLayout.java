...
public class DashboardLayout extends ToolbarLayout implements ActionListener {
	...
	protected Component createCenterComponent() {
		...
		// This is experimental... can I add a JPanel to a button?
	    panel = p(false);
	    	//panel.setLayout(new BoxLayout(panel, BoxLayout.LINE_AXIS)); //(new FlowLayout(FlowLayout.LEFT, 0, 5));
	    	button = b(""); button.setIcon(null); button.setPressedIcon(null);
	    	button.setLayout(new BorderLayout());
	    		...
	    		button.add(pp, BorderLayout.CENTER);
			panel.add(button);
	    container.add(panel);

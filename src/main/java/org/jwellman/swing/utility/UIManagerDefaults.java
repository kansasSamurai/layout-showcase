package org.jwellman.swing.utility;
 ...
 *  
 *  Blog: https://tips4java.wordpress.com/2008/10/09/uimanager-defaults/
 *  Original Source Code: http://www.camick.com/java/source/UIManagerDefaults.java
 *  
 *  I would also like to incorporate the following but cannot find the source code:
...
public class UIManagerDefaults implements ActionListener, ItemListener {
	...
	private JRadioButton byValueType;
	...
	private JComponent buildNorthComponent()
	{
	    ...
	    byValueType = new JRadioButton("By Value Type");
	...
	/*
	 *  Some rows containing icons, may need to be sized taller 
	...
	class SampleRenderer extends JLabel implements TableCellRenderer {
		 ...
		 *  shared by other items. This code will catch the ClassCastException that is thrown.
		 */
